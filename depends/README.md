...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_electrumcoin` executable (see https://github.com/electrumcoincon/electrumcoincon/pull/13543),
