...
"""Test objects for interacting with a electrumcoind node over the p2p protocol.

The P2PInterface objects interact with the electrumcoind nodes under test using the
