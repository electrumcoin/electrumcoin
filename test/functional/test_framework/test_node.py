...
class TestNode():
    ...
    def __init__(self, i, datadir, *, chain, rpchost, timewait, timeout_factor, electrumcoind, electrumcoincon_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None, descriptors=False):
        """
        Kwargs:
        ...
        self.electrumcoinconf = os.path.join(self.datadir, "litecoin.conf")
        self.stdout_dir = os.path.join(self.datadir, "stdout")
        self.stderr_dir = os.path.join(self.datadir, "stderr")
        self.chain = chain
        self.rpchost = rpchost
        self.rpc_timeout = timewait
        self.binary = electrumcoind
        ...
        # Configuration for logging is set as command-line args rather than in the electrumcoin.conf file.
        # This means that starting a electrumcoind using the temp dir to debug a failed test won't
        # spam debug.log.
        self.args = [
            self.binary,
        ...
        self.cli = TestNodeCLI(electrumcoin_cli, self.datadir)
    ...
    def __del__(self):
        # Ensure that we don't leave any electrumcoind processes lying around after
        # the test ends
    ...
    def start(self, extra_args=None, *, cwd=None, stdout=None, stderr=None, **kwargs):
        ...
        # Add a new stdout and stderr file each time electrumcoind is started
        if stderr is None:
        ...
        # unclean shutdown), it will get overwritten anyway by electrumcoind, and
    ...
    def wait_for_rpc_connection(self):
        ...
        for _ in range(poll_per_s * self.rpc_timeout):
            ...
            except ValueError as e:  # cookie file not found and no rpcuser or rpcpassword; electrumcoind is still starting
    ...
    def wait_for_cookie_credentials(self):
        ...
        for _ in range(poll_per_s * self.rpc_timeout):
            try:
                ...
                return
            except ValueError:  # cookie file not found and no rpcuser or rpcpassword; electrumcoind is still starting
...
class TestNodeCLI():
    ...
    def __init__(self, binary, datadir):
        ...
        self.datadir = datadir
        self.input = None
        self.log = logging.getLogger('TestFramework.electrumcoincli')

    def __call__(self, *options, input=None):
        # TestNodeCLI is callable with electrumcoin-cli command-line options
