...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and electrumcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test electrumcoin-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test electrumcoin-cli -generate with -rpcwallet in multiwallet mode.
