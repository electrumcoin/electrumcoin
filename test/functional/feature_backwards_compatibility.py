...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes electrumcoind to exit, in addition to the RPC
        ...
        # Make sure this wallet opens without warnings. See https://github.com/electrumcoin/electrumcoincon/pull/19054
