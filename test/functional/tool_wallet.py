...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def electrumcoin_wallet_process(self, *args):
    ...
    def assert_raises_tool_error(self, error, *args):
        p = self.electrumcoin_wallet_process(*args)
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `electrumcoin-wallet help` raises an error. Use `electrumcoincon-wallet -help`.
        ...
        if self.options.descriptors:
            error = "SQLiteDatabase: Unable to obtain an exclusive lock on the database, is it being used by another electrumcoind?"
    ...
    def test_salvage(self):
        # TODO: Check salvage actually salvages and doesn't break things. https://github.com/electrumcoin/electrumcoincon/issues/7463
