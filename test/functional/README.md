...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/electrumcoin/electrumcoincon/pull/14884#discussion_r239585126).
...
Taken from the [python-electrumcoinrpc repository](https://github.com/jgarzik/python-electrumcoinconrpc).
...
Utilities for manipulating transaction scripts (originally from python-electrumcoinlib)
