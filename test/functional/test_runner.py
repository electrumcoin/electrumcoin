...
def main():
    ...
    enable_electrumcoind = config["components"].getboolean("ENABLE_BITCOIND")

    if not enable_electrumcoind:
...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, use_term_control):
    ...
    # Warn if electrumcoind is already running
    try:
