Bitcoin Core version 0.16.3 is now available from:
  ...
  <https://electrumcoincore.org/bin/electrumcoincon-core-0.16.3/>
...
### Miscellaneous
- #13655 `1cdbea7` electrumcoinconsensus: invalid flags error should be set to `electrumcoinconconsensus_err` (afk11)
