...
Bitcoin Core version 0.21.0 is now available from:
  ...
  <https://electrumcoincore.org/bin/electrumcoincon-core-0.21.0/>
...
- This release adds support for Tor version 3 hidden services, and rumoring them
  ...
  [BIP155](https://github.com/electrumcoin/bips/blob/master/bip-0155.mediawiki).
...
- This release adds support for serving
  [BIP157](https://github.com/electrumcoin/bips/blob/master/bip-0157.mediawiki) compact
...
- This release adds support for signets
  ([BIP325](https://github.com/electrumcoin/bips/blob/master/bip-0325.mediawiki)) in
...
- This release implements
  [BIP339](https://github.com/electrumcoin/bips/blob/master/bip-0339.mediawiki)
...
- This release implements the proposed Taproot consensus rules
  ([BIP341](https://github.com/electrumcoin/bips/blob/master/bip-0341.mediawiki) and
  [BIP342](https://github.com/electrumcoin/bips/blob/master/bip-0342.mediawiki)),
...
- A new `electrumcoin-cli -netinfo` command provides a network peer connections
...
- A new `electrumcoin-cli -generate` command, equivalent to RPC `generatenewaddress`
  followed by `generatetoaddress`, can generate blocks for command line testing
  purposes. This is a client-side version of the former `generate` RPC. See the
  help for details. (#19133)

- The `electrumcoin-cli -getinfo` command now displays the wallet name and balance for
  each of the loaded wallets when more than one is loaded (e.g. in multiwallet
  mode) and a wallet is not specified with `-rpcwallet`. (#18594)

- The `connections` field of `electrumcoin-cli -getinfo` is now expanded to return a JSON
...
- The `-salvagewallet` startup option has been removed. A new `salvage` command
  has been added to the `electrumcoin-wallet` tool which performs the salvage
...
`electrumcoin.conf` or `settings.json` files. And by default it will also load a
top-level unnamed ("") wallet. However, if specified wallets don't exist,
Bitcoin Core will now just log warnings instead of creating new wallets with
new keys and addresses like previous releases did.

New wallets can be created through the GUI (which has a more prominent create
wallet option), through the `electrumcoin-cli createwallet` or `electrumcoincon-wallet
...
Bugs and missing functionality can be reported to the [issue tracker](https://github.com/electrumcoin/electrumcoincon/issues).
...
- Wallets created or loaded in the GUI will now be automatically loaded on
  ...
  `\<datadir\>/settings.json` and augments any command line or `electrumcoin.conf`
...
- #19284 Add seed.electrumcoin.wiz.biz to DNS seeds (wiz)
...
- #20198 Show name, format and if uses descriptors in electrumcoin-wallet tool (jonasschnelli)
...
- #19133 rpc, cli, test: add electrumcoin-cli -generate command (jonatack)
...
- #20055 Set HTTP Content-Type in electrumcoin-cli (laanwj)
...
### Build system
- #18504 Drop electrumcoin-tx and electrumcoincon-wallet dependencies on libevent (ryanofsky)
...
- #18653 add coverage for electrumcoin-cli -rpcwait (jonatack)
...
- #19061 Add link to Visual Studio build readme (maitreelectrumcoin)
...
- #18817 Document differences in electrumcoind and electrumcoincon-qt locale handling (practicalswift)
...
[Transifex](https://www.transifex.com/electrumcoin/electrumcoincon/).
