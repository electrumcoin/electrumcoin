...
http://sourceforge.net/projects/electrumcoin/files/Bitcoin/electrumcoincon-0.5.3/
...
http://gitorious.org/electrumcoin/electrumcoincond-stable/archive-tarball/v0.5.3#.tar.gz
...
Handle invalid Bitcoin URIs using "electrumcoin://" instead of "electrumcoincon:".
