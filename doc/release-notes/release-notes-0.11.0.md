Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://electrumcoin.org/bin/electrumcoincon-core-0.11.0/>
...
For example, add the following to `electrumcoin.conf`:
...
related to the blockchain in the electrumcoin system: the raw blocks as received over 
...
For an example script see [electrumcoin-submittx](https://github.com/laanwj/electrumcoincon-submittx).
...
- #5334 `cf87536` libelectrumcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new electrumcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add electrumcoin logo to about screen
...
- #5809 `46bfbe7` Add electrumcoin-cli man page
...
- #5849 `41259ca` contrib/init/electrumcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for electrumcoin-tx)
