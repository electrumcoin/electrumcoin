Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://electrumcoin.org/bin/electrumcoincon-core-0.13.2/>
...
- #8908 `4a974b2` Update electrumcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow electrumcoin-tx to create v2 transactions (btcdrak)
