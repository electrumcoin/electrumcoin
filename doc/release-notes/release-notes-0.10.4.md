Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://electrumcoin.org/bin/electrumcoincon-core-0.10.4/>
...
- #6953 `43c2789` Split electrumcoin-tx into its own package
- #6953 `dfe0d4d` Include electrumcoin-tx binary on Debian/Ubuntu
