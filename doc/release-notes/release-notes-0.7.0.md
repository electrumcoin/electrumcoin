Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/electrumcoin/files/Bitcoin/electrumcoincon-0.7.0/

We recommend that everybody running prior versions of electrumcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/electrumcoin/electrumcoincon/tarball/v0.7.0  # .tar.gz
  https://github.com/electrumcoin/electrumcoincon/zipball/v0.7.0  # .zip
...
in your terminal, then install the electrumcoin-qt package:
  sudo apt-get install electrumcoin-qt
...
(on Mac) or
Code:
electrumcoind/electrumcoincon-qt
(on Linux).
...
Core electrumcoin handling and blockchain database
...
* Ensure a changed electrumcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for electrumcoin-qt.exe
* (Windows only): add meta-data to electrumcoin-qt.exe (e.g. description)
...
* Bash programmable completion for electrumcoind(1)
