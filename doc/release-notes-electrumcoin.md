Litecoin Core version 0.21.3 is now available from:
 ...
 <https://download.electrumcoin.org/electrumcoin-0.21.3/>.

This is a new patch version release that includes, new features and important security updates.

Please report bugs using the issue tracker at GitHub:

  <https://github.com/electrumcoin-project/electrumcoin/issues>
...
New MWEB features
--------------------------
- `215edcf` - `1049218`: add MWEB light client p2p messages. This implements [LIP006](https://github.com/electrumcoin-project/lips/blob/c01068d06136fb21bf35fd6dac2977de60057714/LIP-0006.mediawiki). 
- `4c3d4f2`: adds new NODE_MWEB_LIGHT_CLIENT service flag. Enables BIP157/158 blockfilters by default (opt-out by default). 

Build changes
--------------------------
- `bf355d2`: rename the PID file to electrumcoind.pid
...
- [The Bitcoin Core Developers](https://github.com/electrumcoin/electrumcoincon/)
