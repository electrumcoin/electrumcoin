...
- #13797 `6518bcd` electrumcoinconsensus: invalid flags should be set to electrumcoinconconsensus_error type, add test cases covering electrumcoinconconsensus error codes (Thomas Kerin)
