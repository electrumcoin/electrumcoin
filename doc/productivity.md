...
```sh
make src/electrumcoind src/electrumcoincon-cli
make src/qt/electrumcoin-qt
make -C src electrumcoin_bench
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:electrumcoin/electrumcoincon.git
```
