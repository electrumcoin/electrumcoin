...
# libFuzzer" on https://github.com/electrumcoin/electrumcoincon/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
The project's collection of seed corpora is found in the [`electrumcoin-core/qa-assets`](https://github.com/electrumcoincon-core/qa-assets) repo.

To fuzz `process_message` using the [`electrumcoin-core/qa-assets`](https://github.com/electrumcoincon-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/electrumcoin-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`electrumcoin-core/qa-assets`](https://github.com/electrumcoincon-core/qa-assets) repo.

Every single pull request submitted against the Litecoin Core repo is automatically tested against all inputs in the [`electrumcoin-core/qa-assets`](https://github.com/electrumcoincon-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Litecoin Core more robust.
...
```sh
$ git clone https://github.com/electrumcoin/electrumcoincon
$ cd electrumcoin/
$ ./autogen.sh
