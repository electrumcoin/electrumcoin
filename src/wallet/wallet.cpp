...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const boost::optional<MWEB::WalletTxInfo>& mweb_wtx_info, const CWalletTx::Confirmation& confirm, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/electrumcoin/electrumcoincon/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/electrumcoin/electrumcoincon/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason, uint64_t mempool_sequence) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/electrumcoin/electrumcoincon/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/electrumcoin/electrumcoincon/pull/9371 and the prior sync
        ...
        // https://github.com/electrumcoin-core/electrumcoincon-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
        SyncTransaction(tx, boost::none, {CWalletTx::Status::UNCONFIRMED, /* block height */ 0, /* block hash */ {}, /* index */ 0});
    }
}
    ...
    while (!fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, FoundBlock().data(block)) && !block.IsNull()) {
            ...
            if (reorg) {
                ...
                // https://github.com/electrumcoin/electrumcoincon/pull/14711#issuecomment-458342518
 ...
 * https://electrumcointalk.org/?topic=54527, or
 * https://github.com/electrumcoin/electrumcoincon/pull/1393.
 */
