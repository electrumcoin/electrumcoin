...
static bool AppInit(int argc, char* argv[])
{
    ...
    // If Qt is used, parameters/electrumcoin.conf are parsed in qt/electrumcoincon.cpp's main()
    ...
    try
    {
        ...
        // -server defaults to true for electrumcoind but not for the GUI so do this here
...
int main(int argc, char* argv[])
{
    ...
    // Connect electrumcoind signal handlers
    noui_connect();
