...
{
    BOOST_CHECK(TestSplitHost("www.electrumcoincore.org", "www.electrumcoinconcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.electrumcoincore.org]", "www.electrumcoinconcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.electrumcoincore.org:80", "www.electrumcoinconcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.electrumcoincore.org]:80", "www.electrumcoinconcore.org", 80));
