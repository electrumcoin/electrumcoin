 ...
 * for both electrumcoind and electrumcoincon-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("ElectrumcoinCore");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/electrumcoin/bips/blob/master/bip-0014.mediawiki)
 */
