...
#include <qt/electrumcoin.h>
#include <qt/electrumcoingui.h>
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. electrumcoin_de.qm (shortcut "de" needs to be defined in electrumcoincon.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. electrumcoin_de_DE.qm (shortcut "de_DE" needs to be defined in electrumcoincon.qrc)
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if(success)
    {
        ...
        // electrumcoin: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    Q_INIT_RESOURCE(electrumcoin);
    Q_INIT_RESOURCE(electrumcoin_locale);
    ...
    /// 6. Determine availability of data directory and parse electrumcoin.conf
    ...
    // electrumcoin: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
