...
#include <qt/electrumcoinunits.h>
    ...
    mapper(nullptr)
{
    ...
    ui->electrumcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->electrumcoinAtStartup);
    ...
    ui->electrumcoinAtStartup->setToolTip(ui->electrumcoinconAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->electrumcoinAtStartup->setText(ui->electrumcoinconAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->electrumcoinAtStartup, OptionsModel::StartAtStartup);
