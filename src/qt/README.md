...
ClientModel is used by the main application `electrumcoingui` and several models like `peertablemodel`.
...
* `electrumcoinstrings.cpp`: automatically generated
* `electrumcoinunits.(h/cpp)`: BTC / mBTC / etc handling
* `callback.h`
...
* don't change `local/electrumcoin_en.ts`; this happens [automatically](/doc/translation_process.md#writing-code-with-translations)
