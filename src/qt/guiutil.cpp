...
#include <qt/electrumcoinaddressvalidator.h>
...
{
    // return if URI is not valid or is no electrumcoin: URI
...
bool openBitcoinConf()
{
    ...
    /* Open electrumcoin.conf with the associated application */
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (!optionFile.good())
            return false;
        std::string chain = gArgs.GetChainName();
        // Write a electrumcoin.desktop file to the autostart directory:
