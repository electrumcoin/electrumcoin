...
#include <qt/electrumcoinamountfield.h>
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_electrumcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_electrumcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_electrumcoin-qt  # macOS
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_electrumcoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
