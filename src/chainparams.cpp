...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
	...
	const char pszTimestamp = "Ruters 28/Apr/2024 Elon Musk headed to visit Tesla's second bigest market China";
	// public_key:  3fb476627a32970c42530e5fd845418f4d46a41bc1aaeee2847492b3127649315b408b2deac3639061328107840f02db80625e85ede8b310016b1964cc8fd50b
    //const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
	const CScript genesisOutputScript = CScript() << ParseHex("0415f0d37ac361427e69debde4e56ba4152a9c8add5a7040613839398c094b8bba663f7616a5b07582aba877da01dab2387fe6579d6c23766530b20dd47de3b511") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP16Height = 1; //218579; // 87afb798a3ad9378fcd56123c81fb31cfd9a8df4719b9774d71730c16315a092 - October 1, 2012
        consensus.BIP34Height = 1; //710000;
        consensus.BIP34Hash = uint256();//uint256S("0xfa09d204a83a768ed5a7c8d441fa62f2043abf420cff1226c7b4329aeb9d51cf");
        consensus.BIP65Height = 1;//918684; // bab3041e8977e0dc3eeff63fe707b92bde1dd449d8efafb248c27c8264cc311a
        consensus.BIP66Height = 811879; // 7aceee012833fa8952f8835d8b1b3ae233cd6ab08fdb27a771d2bd7bdc491894
        consensus.CSVHeight = 1;//1201536; // 53e0af7626f7f51ce9f3b6cfc36508a5b1d2f6c4a75ac215dc079442692a4c0b
        consensus.SegwitHeight = 1;//1201536; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        ...
        consensus.nRuleChangeActivationThreshold = 15120; //6048; // 75% of 8064
        consensus.nMinerConfirmationWindow = 20160; //8064; // nPowTargetTimespan / nPowTargetSpacing * 4
        ...
        //genesis = CreateGenesisBlock(1317972665, 2084524493, 0x1e0ffff0, 1, 100 * COIN);
		genesis = CreateGenesisBlock(1714318128, 2084524493, 0x1e0ffff0, 1, 150 * COIN);
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Hash = uint256();//uint256S("8075c771ed8b495ffd943980a95f702ab34fce3c8c54e379548bda33cc8c0573");
        ...
        consensus.nMinerConfirmationWindow = 5040; //2016; // nPowTargetTimespan / nPowTargetSpacing
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = Consensus::BIP9Deployment::NEVER_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        ...
        // Deployment of Taproot (BIPs 340-342)
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartHeight = 0; // March 2022
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeoutHeight = 524160;//2435328; // 364 days later

        // Deployment of MWEB (LIP-0002, LIP-0003, and LIP-0004)
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartHeight = 0; // Jan/Feb 2022
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeoutHeight = 524160;//2419200; // 364 days later
		...
		genesis = CreateGenesisBlock(1714318975, 293345, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
		...
		genesis = CreateGenesisBlock(1714318985, 0, 0x207fffff, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
