...
[good first issue](https://github.com/electrumcoin/electrumcoincon/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/electrumcoin/electrumcoincon/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Bitcoin Core PR Review Club](https://electrumcoincore.reviews/) meeting.
...
`#electrumcoin-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/electrumcoin-core-dev/](http://www.erisian.com.au/electrumcoincon-core-dev/)
and [http://gnusha.org/electrumcoin-core-dev/](http://gnusha.org/electrumcoincon-core-dev/).
...
For GUI-related issues or pull requests, the https://github.com/electrumcoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/electrumcoin/electrumcoincon node repository should be used.
...
[Translation Process](https://github.com/electrumcoin/electrumcoincon/blob/master/doc/translation_process.md)
...
https://github.com/electrumcoin/electrumcoincon/pull/16189).

Also see the [backport.py script](
https://github.com/electrumcoin-core/electrumcoincon-maintainer-tools#backport).
