...
Additional tools, including the `github-merge.py` script, are available in the [maintainer-tools](https://github.com/electrumcoin-core/electrumcoincon-maintainer-tools) repository.
...
All other packaging related files can be found in the [electrumcoin-core/packaging](https://github.com/electrumcoincon-core/packaging) repository.

### [Gitian-descriptors](/contrib/gitian-descriptors) ###
Files used during the gitian build process. For more information about gitian, see the [the Bitcoin Core documentation repository](https://github.com/electrumcoin-core/docs).
