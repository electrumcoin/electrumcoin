...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/electrumcoin/' to
        #     '/home/satoshi/electrumcoin/'). This means that the $PWD inside the
        ...
        #                      according to SPEC
        #
        #   --share="$PWD"=/electrumcoin
        #
        #                     maps our current working directory to /electrumcoin
        ...
        #     container so that we have something to build. '/electrumcoin' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /electrumcoin && bash contrib/guix/libexec/build.sh"
    )
