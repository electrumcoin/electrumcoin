...
EXCLUDE = [
    # auto generated:
    'src/qt/electrumcoinstrings.cpp',
...
Arguments:
    <base_directory> - The base directory of a electrumcoin source code repository.
...
Arguments:
    <file> - A source file in the electrumcoin repository.
"""
