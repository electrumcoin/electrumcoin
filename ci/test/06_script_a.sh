...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # details.
  DOCKER_EXEC 'grep -v HAVE_SYS_GETRANDOM src/config/electrumcoin-config.h > src/config/electrumcoincon-config.h.tmp && mv src/config/electrumcoincon-config.h.tmp src/config/electrumcoincon-config.h'
fi
