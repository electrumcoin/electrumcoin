...
libs = [
    'libelectrumcoin_cli',
    'libelectrumcoin_common',
    'libelectrumcoin_crypto',
    'libelectrumcoin_server',
    'libelectrumcoin_util',
    'libelectrumcoin_wallet_tool',
    'libelectrumcoin_wallet',
    'libelectrumcoin_zmq',
    'bench_electrumcoin',
    'libtest_util',
]
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/electrumcoin_config.h'), os.path.join(SOURCE_DIR, 'config/electrumcoincon-config.h'))
