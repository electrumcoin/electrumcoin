...
// electrumcoin includes.
#include <..\src\script\electrumcoinconsensus.h>
...
int main()
{
    std::cout << "electrumcoinconsensus version: " << electrumcoinconconsensus_version() << std::endl;
    ...
    auto op0Result = electrumcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, electrumcoinconconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
